...
///Containr(
                                  ...
                                  Row(
                                    children: [
                                        Container(
                                          ...
                                          child: Text("Year",textAlign: TextAlign.left ,style: TextStyle(fontSize: 10)),
                                        ),
                                        Container(
                                          width: MediaQuery.of(context).size.width * 0.24,
                                          child: Text("Month",textAlign: TextAlign.left ,style: TextStyle(fontSize: 10)),
                                        ),
                                        Container(
                                          width: MediaQuery.of(context).size.width * 0.24,
                                          child: Text("Date",textAlign: TextAlign.left ,style: TextStyle(fontSize: 10)),
                                        ),
                                        Container(
                                          width: MediaQuery.of(context).size.width * 0.24,
                                          child: Text("Start time",textAlign: TextAlign.left ,style: TextStyle(fontSize: 10)),
                                        ),
                                  ...
                                  Row( children: [
                                    Container(
                                        ...
                                        child:
                                          DropdownButton<String>(
                                            isExpanded: true,
                                            hint:  Text(_selectedYear, textAlign: TextAlign.center,  style:TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),                
                                    ...
                                    Container(
                                      ...
                                      child:
                                          Container(
                                            ...
                                            hint:  Text(_selectedMonth, textAlign: TextAlign.center, style:TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                                            isExpanded: true,
                                            items: <String>['01', '02', '03', '04','05','06','07','08','09','10','11','12'].map((String value) {
                                              return new DropdownMenuItem<String>(
                                                ...
                                                child: Center(
                                                  child:
                                                    new Text(value, textAlign: TextAlign.center, style:TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                                                ),
                                              );
                                            }).toList(),
                                            onChanged: (value) {
                                    ...
                                    Container(
                                      ...
                                      child:
                                        DropdownButton<String>(
                                          isExpanded: true,
                                          hint:  Text(_selectedDate, textAlign: TextAlign.center, style:TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                              ...
                              child:
                                DropdownButton<String>(
                                  isExpanded: true,
                                  hint:  Text(_selectedStartTime, textAlign: TextAlign.center), style:TextStyle(fontWeight: FontWeight.bold, color: Colors.black),                
                                  ...
                                  onChanged: (value) {
                                    ...
                                    _selectedEndTime = _selectedStartTime.substring(0, 3) + "50";
                                    print("start time is" + _selectedStartTime);
...
///),
                                    ...
                                    Container(
                                      width: double.infinity,
                                      margin: EdgeInsets.fromLTRB(5, 0, 5, 0),
                                      child: Text("Student name", textAlign: TextAlign.left ,style: TextStyle(fontSize: 15)),
                                    ),
                                    Container(
                                      width: double.infinity,
                                      margin: EdgeInsets.fromLTRB(5, 0, 5, 0),
                                      ...
                                      child: Text(snapshot.data["user_username"], textAlign: TextAlign.left, style:TextStyle(color: Colors.black54, fontSize: 20)),                                  
                                    ),
                                    ...
                                    Container(
                                      ...
                                      child: 
                                        TextFormField(
                                          controller: TextEditingController(text: _detailsDescription),
