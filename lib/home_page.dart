...
*/
          ...
          return Card(
              child: GestureDetector(
                  ...
                  onTap: () => {
                        ...
                        Navigator.push(
                          context,
                          SlideRightRoute(page: instructorBio(index: index)),
                        )
                        
                      },
                  child: Column(
                    children: <Widget>[
                      Image.network(snapshot.data[index]["classPhoto"]),
                      Row(
                          ...
                          children: <Widget>[
                            Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    snapshot.data[index]["instructor"],
  ...
  Future<List> fetchApiResults() async {
    final response = await http.get('https://7kkyiipjx5.execute-api.ap-northeast-1.amazonaws.com/api-test/trainers');
